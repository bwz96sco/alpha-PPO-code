...
class TreeNode(object):
    ...
    def __init__(self, parent, prior_p, act =[]):
        ...
        if parent is not None:
            ...
            self._p_seq =  parent._p_seq + self._p_seq
        else:
            self.act_seq = act
...
class MCTSPlayer(object):#undo:step search and policy rollout
    ...
    def __init__(self, policy_value_function,
        ...
        self.beam_size = self.act_size #expand
        self.K = beam_size # beam_choose_grade
        self.first_N = 1
    ...
    def beam_tree_grow(self,game):
        ...
        for i , tree in enumerate(self.forest):
            ...
            dynamic_beam_size = self.beam_size
    ...
    def create_new_forest(self, grade_act_mat_sta):
        indexes = minKIndex2(grade_act_mat_sta,self.K,self.act_size)
        
        first_x, first_y = indexes[0]
        self.temp_best_node  = self.forest[first_x]._children[first_y]
    ...
    def mcts_search(self,game,is_sa_search = False):
        for i in range(self.max_step):
            ...
            self.step_count += 1
        # print(self.temp_best_node._p_seq)
        state_copy = game.board.node_board(self.temp_best_node)
        _,  grade = state_copy.game_end()
        # print()
        return grade
