...
class Agent:
    ...
    def dividePop(self, targetAgent1, targetAgent2):
        subPopSize = targetAgent1.swarm.popuSize
    ...
    def receiveBest(self, sourceAgent1, sourceAgent2):
        subPopSize = sourceAgent1.swarm.popuSize
        self.swarm.population[0:subPopSize] = sourceAgent1.swarm.PsoOp.indiBestAnswer
        self.swarm.population[subPopSize:] = sourceAgent2.swarm.PsoOp.indiBestAnswer
