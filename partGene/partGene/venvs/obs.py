...
class Observation:
    ...
    def stackFeature(self,partFea,machTime): #need change
        part_arr = np.zeros((self.feaArea,obConfig.stockFea))
        part_arr[self.scheduler.model_seq] = partFea
        part_obs = part_arr.T.reshape(-1,self.feaWidth,self.feaHeight)
